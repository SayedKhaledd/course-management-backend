...
VALUES (nextval('refund_status_id_sequence'), 'CONFIRMED', current_timestamp, current_timestamp, 'system', 'system',
        false),
       (nextval('refund_status_id_sequence'), 'NOT_CONFIRMED', current_timestamp, current_timestamp, 'system', 'system',
        false),
       (nextval('refund_status_id_sequence'), 'CANCELLED', current_timestamp, current_timestamp, 'system', 'system', false);